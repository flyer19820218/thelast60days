        ...
        for line in lines:
            if "彥君老師：" in line:
                ...
                <div style="margin-bottom: 15px; text-align: left;">
                    <span style="background-color: #e3f2fd; padding: 10px 15px; border-radius: 15px; display: inline-block; max-width: 85%; color: #000; box-shadow: 1px 1px 3px rgba(0,0,0,0.1);">
                        <b>👨‍🏫 彥君老師</b><br>{content}
                    </span>
                </div>
                """
                ...
                <div style="margin-bottom: 15px; text-align: right;">
                    <span style="background-color: #ffe0b2; padding: 10px 15px; border-radius: 15px; display: inline-block; max-width: 85%; text-align: left; color: #000; box-shadow: 1px 1px 3px rgba(0,0,0,0.1);">
                        <b>👩‍🔬 曉臻助教</b><br>{content}
                    </span>
                </div>
                """
            elif line.strip(): # 其他旁白或標題
