    ...
    if len(pdf_b64) > 500:
        ...
        try:
            ...
            <style>
                ...
                /* 按鈕層：絕對定位到右上角對齊 Streamlit */
                .top-btn-container {{
                    position: fixed; top: -55px; right: 0; width: 30%; z-index: 9999;
                ...
                .pdf-view {{ width: 100%; border-radius: 8px; overflow: hidden; border: 1px solid #eee; margin-top: 10px; }}
            ...
            """
            # 在第三格塞一個空的佔位，真正的按鈕會從下方 HTML 裡浮上來
            with col3:
                st.write("") 
            
            # 渲染完整內容
            components.html(full_app_html, height=1100)
